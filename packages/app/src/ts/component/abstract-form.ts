...
export abstract class AbstractFormElement extends BaseElement {
  ...
  protected renderCompleteStateTemplate_() {
    return html`
      <div class="bg-surfaceVariant text-primary p-8 text-bodyLarge flex flex-col items-center gap-5 rounded-3xl">
        <div
          class="w-12 h-12 rounded-full bg-primary p-2 flex items-center justify-center"
        >
          <svg
            aria-hidden="true"
          ...
          >
            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0
              011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
          </svg>
  ...
  override render() {
    return renderState(this.renderState_, {
      _default: 'initial',
